...
image_dir = "./data(180)/images"
testing_dir = "./data(180).testing/*.tif"
file_names = sorted(os.listdir(image_dir))

X = sorted(glob(testing_dir))
X = list(map(imread,X))
...
model = StarDist2D(None, name='customStardist_180_v1_epochs_300', basedir='models')
...
def example(model, i, show_dist=True):
    ...
    plt.savefig(f"/scratch/awil743/modeltesting/prediction_{i}.png", dpi=400)  # Modify the filename as needed
